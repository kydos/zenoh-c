...
z_list_t * _zn_get_subscriptions_by_rid(zn_session_t *z, z_int_t rid);
...
z_list_t * _zn_get_storages_by_rid(zn_session_t *z, z_int_t rid);
...
z_list_t * _zn_get_evals_by_rid(zn_session_t *z, z_int_t rid);
